	...
	<div id="page_content" style="left: 0px; top: 19px">
		...
		<div id="sidebar">
			<ul>
				...
				<li><a href="default.php">Children</a></li>
				...
				<li><a href="../profile/default.php">Profile</a></li>
			</ul>
		</div>
		<!-- End Sidebar -->
		<!-- Begin Content -->
		<div id="content">
			...
			<h2>Children</h2>
			<p><a href="../PHP-Login/auth.php">Lorem</a> ipsum dolor sit amet, consectetuer adipiscing elit. Quisque 
